...
/// \rcs_id $Id: CorGuess.cpp 2883 2012-11-12 03:58:57Z jmarsden6@gmail.com $
...
void Guesser::CalculateCorrespondences() // Calculate correspondences // 1.6.1aj Make this a function
	...
	if ( corlstSuffGuess.bIsEmpty() ) // If correspondences have not been calculated, do it now
		...
		corlstSuffGiven.SortLongestFirst(); // 1.6.1bd Sort given affixes and roots by length
		corlstPrefGiven.SortLongestFirst(); // 1.6.1bd Sort given affixes and roots by length
