...
public:
    ...
    _eEncoding WhichEncoding(LPVOID pbBuff, INT lNumRead, MLDETECTCP eDataType = MLDETECTCP_8BIT);
};
...
//  CStudioProcessorLib)
inline _eEncoding MyML2Ptr::WhichEncoding(LPVOID pbBuff, INT lNumRead, MLDETECTCP eDataType /* = MLDETECTCP_8BIT */ )
{
    ASSERT( !!(*this) );
